...
void PaymentServer::ipcParseCommandLine(int argc, char *argv[]) {
    for (int i = 1; i < argc; i++) {
        ...
        // If the bitcoinclashic: URI contains a payment request, we are not able
        ...
        if (arg.startsWith(GUIUtil::URI_SCHEME + ":",
                           Qt::CaseInsensitive)) // bitcoinclashic: URI
        {
...
PaymentServer::PaymentServer(QObject *parent, bool startLocalServer)
    ...
    // on Mac: sent when you click bitcoinclashic: links
...
//
// OSX-specific way of handling bitcoinclashic: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager() {
    ...
    // netManager is used to fetch paymentrequests given in bitcoinclashic: URIs
