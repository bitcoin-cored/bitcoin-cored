...
const char *BIP71_MIMETYPE_PAYMENT = "application/bitcoincore-payment";
const char *BIP71_MIMETYPE_PAYMENTACK = "application/bitcoincore-paymentack";
const char *BIP71_MIMETYPE_PAYMENTREQUEST =
    "application/bitcoincore-paymentrequest";
...
void PaymentServer::ipcParseCommandLine(int argc, char *argv[]) {
    for (int i = 1; i < argc; i++) {
        ...
        // If the bitcoincore: URI contains a payment request, we are not able
        ...
        if (arg.startsWith(GUIUtil::URI_SCHEME + ":",
                           Qt::CaseInsensitive)) // bitcoincore: URI
        {
...
PaymentServer::PaymentServer(QObject *parent, bool startLocalServer)
    ...
    // on Mac: sent when you click bitcoincore: links
...
//
// OSX-specific way of handling bitcoincore: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager() {
    ...
    // netManager is used to fetch paymentrequests given in bitcoincore: URIs
