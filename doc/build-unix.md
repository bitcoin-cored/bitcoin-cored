...
This will build core-qt as well if the dependencies are met.
...
If you want to build Core-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a core-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip cored" to strip the debug
