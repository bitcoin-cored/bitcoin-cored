...
2. Run a bitcoin-abcd hidden server
------------------------------
...
This new feature is enabled by default if Bitcoin ABCD is listening (`-listen`), and
...
- Do not add anything but bitcoin-abcd ports to the hidden service created in section 2.
