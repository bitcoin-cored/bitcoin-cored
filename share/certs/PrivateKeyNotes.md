...
unlocked to sign the Core-Qt.app bundle.
...
allowing somebody to distribute a Core-Qt.app or core-qt-setup.exe with a valid
...
that the core-qt.exe file inside the installer had not been tampered with.
