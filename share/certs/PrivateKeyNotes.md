...
unlocked to sign the Clashic-Qt.app bundle.
...
allowing somebody to distribute a Clashic-Qt.app or clashic-qt-setup.exe with a valid
...
that the clashic-qt.exe file inside the installer had not been tampered with.
