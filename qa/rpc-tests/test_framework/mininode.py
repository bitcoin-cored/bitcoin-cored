...
# Objects that map to cored objects, which can be serialized/deserialized
...
class CTransaction(object):
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in cored
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in cored indicates these should be deserialized as blocks
