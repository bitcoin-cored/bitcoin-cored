...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes cored to (reasonably!) disconnect us, so do
    # this last.
    ...
    # Test that cored requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cored to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cored will not send blocktxn responses for blocks whose height is
